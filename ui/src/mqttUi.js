...
export default (() => {
  return {
    ...
    deivceSearch (startPort, lastPort) {
      ...
      const item = {
        ...
        body: { 'content': { 'id': coupleId, 'cmd': 1001, 'param': { 'saddr': startPort, 'eaddr': lastPort }, 'opid': opid }, 'exkey': null, 'type': 200, 'nid': null, 'extra': null },
        res: null
      }
      ...
      console.log(store.getters['mqtt/getOpid'](opid))
      console.log(store.getters['mqtt/getOpidResLast'])
